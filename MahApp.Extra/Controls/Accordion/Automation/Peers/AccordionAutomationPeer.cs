namespace MahApps.Extra.Automation.Peers
{
    ...
    public class AccordionAutomationPeer : ItemsControlAutomationPeer, ISelectionProvider
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="AccordionAutomationPeer"/> class.
        /// </summary>
        ...
        public bool CanSelectMultiple
        {
            get
            {
                return this.OwnerAccordion.SelectionMode == AccordionSelectionMode.OneOrMore ||
                    this.OwnerAccordion.SelectionMode == AccordionSelectionMode.ZeroOrMore;
            }
        }
        ...
        public bool IsSelectionRequired
        {
            get
            {
                return this.OwnerAccordion.SelectionMode == AccordionSelectionMode.One ||
                    this.OwnerAccordion.SelectionMode == AccordionSelectionMode.OneOrMore;
            }
        }
        ...
        private Accordion OwnerAccordion
        {
            get { return (Accordion)this.Owner; }
        } 
        ...
        protected override List<AutomationPeer> GetChildrenCore()
        {
            ...
            for (int i = 0; i < items.Count; i++)
            {
                ...
                if (element != null)
                {
                    peers.Add(UIElementAutomationPeer.FromElement(element) ?? UIElementAutomationPeer.CreatePeerForElement(element));
                }
            }
